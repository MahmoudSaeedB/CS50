...

{
    ...
    for (int i = 0; i < height; i++)
    {
        ...
        {
            // Make an array of 9 elements for pixels within 1 row and colomn of the pixel (forming a 3*3 square)
            ...
            for (int k = 0; k < 3; k++)
            {
                for (int l = 0; l < 3; l++)
                {
                    ...
                    if (pixel_row >= 0 && pixel_row < height && pixel_colomn >= 0 && pixel_colomn < width)
                    {
